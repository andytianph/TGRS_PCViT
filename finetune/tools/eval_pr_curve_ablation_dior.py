...
MODEL_NAME1 = "ViTDet_PCViT_Base_FPN_xP"
OUT_DIR1 = "ViTDet_PCViT_Base_FPN_xP"
CONFIG_FILE1 = f"../configs/{EXPERIMENT}/{DATA}/{MODEL_NAME1}.py"
RESULT_FILE1 = f"../work_dirs/{DATA}/{OUT_DIR1}/best.pkl"

MODEL_NAME2 = "ViTDet_PCViT_Base_FPN_FastConvPre"
OUT_DIR2 = "ViTDet_PCViT_Base_FPN_FastConvPre"
CONFIG_FILE2 = f"../configs/{EXPERIMENT}/{DATA}/{MODEL_NAME2}.py"
RESULT_FILE2 = f"../work_dirs/{DATA}/{OUT_DIR2}/best.pkl"

MODEL_NAME3 = "ViTDet_PCViTknn_Base_FPN_FastConvPre"
OUT_DIR3 = "ViTDet_PCViT_knn_Base_FPN_2x"
CONFIG_FILE3 = f"../configs/{EXPERIMENT}/{DATA}/{MODEL_NAME3}.py"
RESULT_FILE3 = f"../work_dirs/{DATA}/{OUT_DIR3}/best.pkl"

MODEL_NAME4 = "ViTDet_PCViTknn_Base_FRPN_FastConvPre"
OUT_DIR4 = "ViTDet_PCViT_knn_Base_FRPN_2x"
...
def plot_pr_curve(config_file, result_file, metric="bbox"):
    ...
    precisions[0, :, 9, 0, 2] + precisions[0, :, 10, 0, 2] + precisions[0, :, 11, 0, 2] + \
    precisions[0, :, 12, 0, 2] + precisions[0, :, 13, 0, 2] + precisions[0, :, 14, 0, 2] + \
    precisions[0, :, 15, 0, 2] + precisions[0, :, 16, 0, 2] + precisions[0, :, 17, 0, 2] + \
    precisions[0, :, 18, 0, 2] + precisions[0, :, 19, 0, 2]) / 20
