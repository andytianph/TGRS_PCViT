...
class WindowAttention_knn(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0., attn_head_dim=None, topk=100):
    ...
    def forward(self, x, H, W):
        ...
        new_B, new_N, new_C = x.shape
        # the core code block
        mask=torch.zeros(new_B, self.num_heads, new_N, new_N, device=x.device, requires_grad=False)
