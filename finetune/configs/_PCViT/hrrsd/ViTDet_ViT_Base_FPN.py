...
pretrained = '/home/data/jiyuqing/.tph/ViTDet/work_dirs/ckpt/pretrained/mae_pretrain_vit_base.pth'  # noqa
# model settings
model = dict(
    type='FasterRCNN',
...
work_dir = './work_dirs/hrrsd/ViTDet_ViT_Base_FPN'